...
var bkElement = bkClass.extend({
  ...
  getStyle: function (cssRule, d) {
    ...
    if (this.nodeType == 1) { return (doc && doc.getComputedStyle) ? doc.getComputedStyle(this, null).getPropertyValue(cssRule) : this.currentStyle[ bkLib.camelize(cssRule) ] }
  },
...
var nicEditorButton = bkClass.extend({
  ...
  updateState: function () {
    if (this.isDisabled) { this.setBg() } else if (this.isHover) { this.setBg('hover') } else if (this.isActive) { this.setBg('active') } else { this.setBg() }
  },
