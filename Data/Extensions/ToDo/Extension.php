...
class TodoExtension extends \WDGWV\CMS\ExtensionBase
{
    ...
    public function _display($url)
    {
        ...
        $items['Extensibility'] = array(
            ...
            'Partial: UBB code extensions' => 100,
        );
        ...
        $items['Administration'] = array(
            ...
            'Extensions: Check Integrity' => 100,
            'Extensions: Cache IntegrityDB' => 100,
            'Extensions: Cache via Database instead of plain text' => 100, // Kinda, now.
            'Extensions: Install (via webinterface)' => 100,
            'Extensions: Search' => 100,
        );
        ...
        $items['Emulation: WordPress'] = array(
            ...
            'Function: `\WDGWV\CMS\emulation\WordPress()->the_content(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->the_post(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->theme_is_home(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->theme_get_dynamic_sidebar_data(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->is_home(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_option(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->theme_get_menu(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->wp_list_pages(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->theme_get_option(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->wp_head(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->body_class(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->remove_action(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_post_format(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_template_part(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->have_posts(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->is_singular(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->wp_title(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->language_attributes(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->theme_page_navigation(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->do_shortcode(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->bloginfo(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_sidebar(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->_e(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_header(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->wp_footer(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_footer(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->wordpress(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->previous_posts_link(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->next_posts_link(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->is_search(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->the_tags(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->is_single(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->is_page(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->is_category(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->is_month(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->the_ID(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->comments_number(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->the_permalink(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->the_category(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->the_author_link(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->the_time(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->the_title(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->comments_link(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->readintro(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->is_tag(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->wp_get_archives(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->wp_list_cats(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_links(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->wp_loginout(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->wp_meta(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->theme_print_sidebar(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->theme_has_layout_part(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_num_queries(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->timer_stop(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->theme_wordpress(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->trailingslashit(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_template_directory(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->esc_url(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->home_url(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->is_day(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_the_date(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->single_cat_title(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_the_author(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_the_author_meta(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_avatar(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->rewind_posts(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->of_get_option(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_query_var(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_search_query(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->do_action(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->is_active_sidebar(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->dynamic_sidebar(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->wp_register(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->post_class(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->edit_post_link(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->comments_template(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->comments_popup_link(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->wp_pagenavi(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->post_password_required(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->have_comments(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->wp_list_comments(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_comment_pages_count(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->previous_comments_link(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->next_comments_link(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->comments_open(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->post_type_supports(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_post_type(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->comment_form(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->has_nav_menu(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->wp_nav_menu(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_post_meta(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->delete_post_meta(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->add_post_meta(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->update_post_meta(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->locate_template(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->apply_filters(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->is_front_page(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->esc_attr(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->is_plugin_active(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_stylesheet_directory_uri(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_pages(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_categories(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->update_option(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->has_post_thumbnail(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->the_post_thumbnail(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_template_directory_uri(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->wp_get_object_terms(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->wp_reset_postdata(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->the_author_posts_link(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->is_sticky(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_search_form(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->add_theme_support(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->add_image_size(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->register_nav_menus(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->load_theme_textdomain(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_locale(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->add_action(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->_n_noop(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->tgmpa(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->add_filter(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->is_admin(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->wp_register_script(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->wp_enqueue_script(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->wp_register_style(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->wp_enqueue_style(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->is_ssl(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->is_author(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->is_year(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->register_sidebar(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->register_widget(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_the_excerpt(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_the_tag_list(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_comment_author_link(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->comment_reply_link(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->comment_text(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->is_loggedin(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->get_bloginfo(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->wp_parse_args(...)`' => 100,
            'Function: `\WDGWV\CMS\emulation\WordPress()->add_shortcode(...)`' => 100,
        );
        ...
        $items['WDGWV/CMS/Hooks.php'] = array(
            'Function: `\WDGWV\CMS\Hooks::shared()->getUBBHooks(...)`' => 100,
        ...
        foreach ($items as $title => $subitems) {
            ...
            foreach ($subitems as $key => $value) {
                ...
                if ($value < 100 || preg_match("/showDone/", $url)) {
                    $contents .= sprintf(
            ...
            if (($c_items != $count / 100) || preg_match("/showDone/", $url)) {
        ...
        $page[0][1] = "---<br /><br />" .
            (preg_match("/showDone/", $url) ? "<a href='/dev/TODO'>Show only remaining items</a>" : "<a href='/dev/TODO/showDone/true'>Show all items</a>") .
            "<br /><br />Overall progress: {$calcItems} of {$allItemsCount} items = {$calcProgress}%<br /><br />";
